...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/assigned/master/_listings/aws-ec2-systems-manager/apis.md
...
- name: Amazon EC2 Systems Manager API
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/assigned/master/_listings/aws-ec2-systems-manager/actionupdatemanagedinstancerole-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/assigned/master/_listings/aws-ec2-systems-manager/actionupdatemanagedinstancerole-get-openapi.md
- name: Amazon EC2 Systems Manager API
  x-api-slug: amazon-ec2-systems-manager-api
  description: Amazon EC2 Systems Manager is a management service that helps you automatically
    collect software inventory, apply OS patches, create system images, and configure
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/assigned/master/_listings/aws-ec2-systems-manager/openapi.md
x-common:
- type: x-api-gallery
